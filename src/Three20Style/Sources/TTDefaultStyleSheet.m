...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (TTStyle*)toolbarCusButton:(UIControlState)state {
    return [self toolbarButtonForState:state
                                 shape:[TTRoundedRectangleShape shapeWithRadius:4.5]
                             tintColor:RGBCOLOR(204, 191, 170)
                                  font:nil];
}
...
- (TTStyle*)grayToolbarButton:(UIControlState)state {
  return
    [self toolbarButtonForState:state
          shape:[TTRoundedRectangleShape shapeWithRadius:4.5]
          tintColor:RGBCOLOR(190, 190, 190)
          font:nil];
}
...
TTStyle* style;//johnliu33 20111102
if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
    ...
    [TTShapeStyle styleWithShape:[TTRoundedRectangleShape
     ...
     [TTBoxStyle styleWithMargin:UIEdgeInsetsMake(-8, 0, 0, 0)
                         padding:UIEdgeInsetsMake(23, 23, 23, 23)
    ...
    [TTShapeStyle styleWithShape:[TTRoundedRectangleShape
                                  shapeWithRadius:0] next:
     [TTBoxStyle styleWithMargin:UIEdgeInsetsMake(-8, 0, 0, 0)
                         padding:UIEdgeInsetsMake(17, 17, 17, 17)
                         minSize:CGSizeMake(0, 0)
                        position:TTPositionStatic next:
