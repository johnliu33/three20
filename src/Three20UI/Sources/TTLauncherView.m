...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (CGFloat)rowHeight {//add by johnliu33
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    switch (buttonIndex) {
        case 0:
        {
            NSLog(@"Delete this button");
             TTLauncherButton* button = objc_getAssociatedObject(alertView, &MyConstantKey);
    ...
    for (TTLauncherButton* button in buttonPage) {
      if (button.closeButton == closeButton) {
          UIAlertView *alert = [[UIAlertView alloc]
                                initWithTitle:@"確認" message:@"確定要刪除此書？"
                                delegate:self
                                cancelButtonTitle:@"確定" otherButtonTitles:@"取消", nil];
          [alert show];
          [alert release];
    objc_setAssociatedObject(alert, &MyConstantKey, button, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
        }
    }
  }
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)setRowCount:(NSInteger)rowCount {  //modify by johnliu33
...
- (void)setCurrentPageIndex:(NSInteger)pageIndex {
    ...
    [_pager setNumberOfPages:[_pages count]];
    [_pager setCurrentPage:pageIndex];
}
