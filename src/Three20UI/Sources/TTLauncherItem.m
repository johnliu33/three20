...
- (id)initWithTitle:(NSString*)title image:(NSString*)image URL:(NSString*)URL
              count:(NSString*)count bookid:(NSString*)bookid{
    if ((self = [self initWithTitle:title image:image URL:URL canDelete:NO count:count
                             bookid:bookid])) {
  }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (id)initWithTitle:(NSString*)title image:(NSString*)image URL:(NSString*)URL
          canDelete:(BOOL)canDelete count:(NSString*)count bookid:(NSString*)bookid{
  if ((self = [super init])) {
...
- (void)encodeWithCoder:(NSCoder*)encoder {
  ...
  [encoder encodeBool:_canDelete forKey:@"canDelete"];
    ...
    [encoder encodeObject:_bookid forKey:@"bookid"];
}
